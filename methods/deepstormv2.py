...
if __name__=='__main__':
    ...
    algo_params = {'lr': args.lr, 'mini_batch': args.mini_batch, 'k0': args.k0,
                   'beta': args.beta, 'init_batch': args.init_batch,
                   'step_type': args.step_type, 'l1': args.l1, 'report': args.report}
    solver = DEEPSTORMv2(algo_params, mixing_matrix, train_loader, init_weights)
